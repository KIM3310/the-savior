...
- **Lane:** Wellness reflection assistant
- **Primary buyer:** Consumer users only with strict safety boundaries
- **First motion:** Safety and escalation-flow review before distribution

## Recommended Architecture

Static or Workers site, consent-aware analytics, optional content API; avoid storing sensitive user entries unless a privacy architecture is approved.
