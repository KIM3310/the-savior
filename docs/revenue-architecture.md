# Revenue Architecture - the-savior
...
| Layer | Decision |
| --- | --- |
| Target buyer / user | consumer wellness user, creator, or small community wanting a calm reflective ritual app |
| Productized offer | ambient reflection app with guided prompts, candle visuals, and shareable runtime brief |
| First paid SKU | premium theme packs, private journal export, and supporter bundle |
| Free lead magnet | free static ritual experience |
| Paid expansion | theme/content packs, ad-free supporter tier, and creator-branded pages |
| Data / workflow moat | visual/audio theme assets, prompt templates, user ritual history, and shareable reflection exports |
| Private inquiry | https://kim3310-doeon-kim-portfolio.pages.dev/?offer=the-savior&inquiry=consumer-prototype-customization#private-inquiry |
...
| Repo-specific launch path | Cloudflare Pages/GitHub Pages, Workers KV for anonymous settings, R2 theme assets, optional OpenRouter/Workers AI for reflection prompts with safety copy |
...
2. Route confidential and commercial requests through the [central Cloudflare D1 private inquiry](https://kim3310-doeon-kim-portfolio.pages.dev/?offer=the-savior&inquiry=consumer-prototype-customization#private-inquiry); keep public GitHub issues limited to non-confidential product discussion.
